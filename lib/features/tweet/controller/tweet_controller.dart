...
class TweetController extends StateNotifier<bool> {
  ...
  void likeTweet(Tweet tweet, UserModel user) async {
    ...
    res.fold((l) => null, (r) {
      // TODO: send notifications to other users
    });
  }
  ...
  void reshareTweet(
    ...
    res.fold(
      (l) => Messanger.showSnackBar(l.message),
      (r) async {
        tweet = tweet.copyWith(
          id: ID.unique(),
          reshareCount: 0,
  ...
  void shareTweet({
    ...
    if (text.isEmpty) {
      Messanger.showSnackBar('tweet cant be empty');
      return;
    }
  ...
  void _shareImageTweet({
    ...
    res.fold((l) => Messanger.showSnackBar(l.message), (r) {
      if (repliedToUserId.isNotEmpty) {
      // show replied notification to the specific user
      }
    });
    state = false;
  }
  ...
  void _shareTextTweet({
    ...
    res.fold((l) => Messanger.showSnackBar( l.message), (r) {
      if (repliedToUserId.isNotEmpty) {
        // TODO: send notification tweet reply
      }
    });
    state = false;
  }
